...
async function saveCategory() {
  ...
  try {
    ...
    Object.keys(categoryForm.value).forEach(key => {
      ...
      // Skip null/undefined values and image (handle separately)
          ...
          <div v-for="category in categoryTree" :key="category.id"
            ...
            <div class="p-4">
              ...
              <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                <button @click="openCreateModal(category.id)" class="text-sm text-[#CF0D0F] hover:underline">
                  + Add Subcategory
                </button>
        ...
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
          ...
          <div
            ...
            <form @submit.prevent="saveCategory" class="px-6 py-4">
              <div class="space-y-4">
                ...
                <div>
                  ...
                  <input v-model="categoryForm.name" @blur="!isEditing && generateSlug()" type="text" required
                ...
                <div>
                  ...
                  <input v-model="categoryForm.slug" type="text" placeholder="auto-generated-from-name"
                    class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-[#CF0D0F] focus:border-[#CF0D0F]" />
                </div>
            ...
            <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end space-x-3">
              ...
              <button @click="saveCategory" :disabled="isSubmitting || !categoryForm.name.trim()"
        ...
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
          ...
          <div
            ...
            <div class="px-6 py-4 bg-gray-50 flex justify-end space-x-3">
              ...
              <button @click="deleteCategory" :disabled="isSubmitting"
