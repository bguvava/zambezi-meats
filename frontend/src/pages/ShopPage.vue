    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="flex flex-col lg:flex-row gap-8">
        ...
        <main class="flex-1">
          ...
          <!-- Active Filters -->
          <div 
            v-if="filters.category || filters.search || filters.minPrice || filters.maxPrice || filters.inStock"
          ...
          >
            ...
            >
              ...
              <button @click="updateFilters({ ...filters, minPrice: null, maxPrice: null })" class="ml-1 hover:text-green-600">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                </svg>
              </button>
            ...
            <button
              @click="productsStore.resetFilters(); router.push({ query: {} })"
          ...
          <!-- Loading State -->
          <div v-if="isLoading" class="grid gap-6" :class="viewMode === 'grid' ? 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-3' : 'grid-cols-1'">
            <div 
              v-for="n in 6" 
              :key="n" 
          ...
          >
            ...
            <template v-for="page in pagination.lastPage" :key="page">
              <button
                v-if="page === 1 || page === pagination.lastPage || Math.abs(page - pagination.currentPage) <= 1"
              ...
              <span 
                v-else-if="page === 2 && pagination.currentPage > 3"
                class="px-2 text-gray-400"
              >
                ...
              </span>
              <span 
                v-else-if="page === pagination.lastPage - 1 && pagination.currentPage < pagination.lastPage - 2"
                class="px-2 text-gray-400"
              >
                ...
              </span>
