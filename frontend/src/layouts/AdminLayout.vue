...
<template>
  <div class="min-h-screen bg-gray-100">
    ...
    <!-- Sidebar -->
    <aside :class="[
      'fixed top-0 left-0 z-50 h-full bg-secondary-900 text-white transform transition-all duration-300 ease-in-out flex flex-col',
      ...
      <div class="h-16 flex items-center justify-between px-4 border-b border-secondary-800"
        ...
        <div class="flex items-center space-x-2" :class="{ 'lg:justify-center': isSidebarCollapsed }">
          <img src="/.github/official_logo-white.png" alt="Zambezi Meats" class="w-8 h-8 rounded-lg object-contain flex-shrink-0" />
      ...
      <div class="p-4 border-b border-secondary-800" :class="{ 'lg:px-2': isSidebarCollapsed }">
        <div class="flex items-center space-x-3" :class="{ 'lg:justify-center': isSidebarCollapsed }">
          <div
            class="w-10 h-10 bg-primary-700 rounded-full flex items-center justify-center flex-shrink-0 overflow-hidden">
          ...
          <div v-if="!isSidebarCollapsed" class="lg:block overflow-hidden">
            <p class="font-medium text-white text-sm truncate">{{ authStore.userName }}</p>
      ...
      <!-- Navigation -->
      <nav class="flex-1 p-4 space-y-1 overflow-y-auto min-h-0" :class="{ 'lg:px-2': isSidebarCollapsed }">
